...
ChiefSlider.prototype._move = function() {
  ...
  if (!this._config.loop) {
    ...
    let preparedTransform = Number(transform.toFixed())
    let preparedEndTransformValue = Number(endTransformValue.toFixed())



    if (preparedTransform === -preparedEndTransformValue) {
